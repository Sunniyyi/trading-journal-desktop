...
assert(output.includes('./ui/backtest-simulations-v223.css'), 'Desktop 2.1.23 Backtesting simulations layer is missing.');
...
assert(output.indexOf('./ui/backtest-overview-v222.css') < output.indexOf('./ui/backtest-simulations-v223.css'), 'Backtesting 2.1.23 simulations layer must override the 2.1.22 overview layer.');
assert(output.indexOf('./ui/backtest-simulations-v223.css') < output.indexOf('./ui/backtest-state-guard.css'), 'Backtesting state guard must remain after the 2.1.23 simulations layer.');
