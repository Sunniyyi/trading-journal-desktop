...
assert(output.indexOf('./ui/journal-polish.css') < output.indexOf('./ui/workspace-routing-fix.css'), 'Workspace visibility guard must remain last so hidden pages always stay hidden.');
